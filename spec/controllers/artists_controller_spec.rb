...
RSpec.describe ArtistsController, type: :controller do
  ...
  describe "GET #edit" do
    it "assigns the requested artist as @artist and renders the edit form" do
      artist = create(:artist)
  ...
  describe "GET #new" do
    it "creates a new artist and renders the new form" do
      get(:new)
  ...
  describe "PUT #update" do
    ...
    context "with invalid params" do
      ...
      it "renders the edit form again for that artist" do
        artist = create(:artist)
        put :update, {:id => artist.to_param, :artist => attributes_for(:artist, name: nil)}
        expect(response).to render_template("edit")
      end
